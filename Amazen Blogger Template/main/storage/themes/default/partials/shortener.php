...
<form action="<?php ee('shorten') ?>" method="post" data-trigger="shorten-form" enctype="multipart/form-data">
    <?php echo csrf() ?>
    <div class="d-flex items-align-center border rounded">
        ...
        <div class="align-self-center me-3">
            <div class="btn-group">
                ...
                <button type="submit" class="btn btn-primary"><?php ee('Shorten') ?></button>
            </div>
        </div>
    </div>
