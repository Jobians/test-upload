    ...
    <div class="flex-grow-1">
        <div class="float-end">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" data-trigger="shortinfo" data-shorturl="<?php echo Helpers\App::shortRoute($url->domain, $url->alias.$url->custom) ?>"><i data-feather="info"></i> <?php ee('More Info') ?></span></a></li>
                ...
                <?php if(user()->teamPermission('links.edit')): ?>
                    <li><a class="dropdown-item" href="<?php echo route('links.edit', [$url->id]) ?>"><i data-feather="edit"></i> <?php ee('Edit') ?></span></a></li>
                    <?php if($url->archived): ?>
                        <li><a class="dropdown-item" href="<?php echo route('links.unarchive', ['link' => $url->id]) ?>" data-trigger="archiveselected"><i data-feather="briefcase"></i> <?php ee('Unarchive') ?></span></a></li>  
                    <?php else: ?>
                        <li><a class="dropdown-item" href="<?php echo route('links.archive', ['link' => $url->id]) ?>" data-trigger="archiveselected"><i data-feather="briefcase"></i> <?php ee('Archive') ?></span></a></li>  
                    <?php endif ?>
                    <?php if($url->public): ?>
                        <li><a class="dropdown-item" href="<?php echo route('links.private', ['link' => $url->id]) ?>" data-trigger="archiveselected"><i data-feather="eye-off"></i> <?php ee('Set Private') ?></span></a></li>  
                    <?php else: ?>
                        <li><a class="dropdown-item" href="<?php echo route('links.public', ['link' => $url->id]) ?>" data-trigger="archiveselected"><i data-feather="eye"></i> <?php ee('Set Public') ?></span></a></li>  
                    <?php endif ?>
                <?php endif ?>
                <?php if(user()->has('export')): ?>
                    <li><a class="dropdown-item" href="<?php echo route('links.stats.export', [$url->id]) ?>"><i data-feather="download"></i> <?php ee('Export Statistics') ?></span></a></li>                    
                <?php endif ?>
                <li><hr class="dropdown-divider"></li>
                <?php if(user()->teamPermission('links.delete')): ?>
                    <li><a class="dropdown-item" href="<?php echo route('links.delete', [$url->id, \Core\Helper::nonce('link.delete')]) ?>" data-bs-toggle="modal" data-trigger="modalopen" data-bs-target="#deleteModal"><i data-feather="trash"></i> <?php ee('Delete') ?></span></a></li>
                <?php endif ?>
            </ul>                        
        </div>
        ...
        <div class="d-block mt-1">            
            ...
            <a href="<?php echo route('stats', [$url->id]) ?>"><small class="text-navy"><?php echo $url->click ?> <?php ee('Clicks') ?></small></a> - 
